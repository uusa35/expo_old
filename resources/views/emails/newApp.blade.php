                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td align="center" style="font:bold 16px/25px Arial, Helvetica, sans-serif; color:#888; padding:0 0 23px; ">
                                                <p>الاسم : <span style="margin-bottom: 10px; overflow: hidden;">{{$name}}</span></p>
                                                <p>البريد الالكتروني : <span style="margin-bottom: 10px; overflow: hidden;">{{$email}}</span></p>

                                                 {{--الاسم : <span style="margin-bottom: 10px; overflow: hidden;">atallah</span>--}}
                                                {{--<p style="margin-bottom: 10px; overflow: hidden;">{!! $app->email!!}</p>--}}
                                            </td>
                                        </tr>
                                        <tr>
