    ...
    <body>
        ...
        <div class="secBody">
           <div class="container">
            <div class="titleBody">
                <h4>Hi {{$name}}</h4>
                <p>Your order num. is : <span>{{$order_id}}</span></p>
            </div>
            <div class="tableBody">
                <table id="customers">
                  <tr>
                ...
                <table id="customers">
                  ...
                  <tr>
                        ...
                        <td><span>{{$item->expo->name}}</span></td>
