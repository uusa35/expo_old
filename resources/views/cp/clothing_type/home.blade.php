        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/clothing_types/create')}}" style="margin-right: 5px"
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/clothing_types')}}">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/clothing_types')}}" type="submit" class="btn sbold btn-default ">{{('reset')}}
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/clothing_types/changeStatus")}}">
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/clothing_types/'.$item->id.'/edit')}}"
    ...
    <script>
        function delete_adv(id, e) {
            ...
            swal({
                ...
                if (willDelete) {
                    var url = '{{url(getLocal()."/admin/clothing_types")}}/' + id;
