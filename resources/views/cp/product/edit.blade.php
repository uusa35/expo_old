                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select id="expo_id" class="form-control select2" name="expo_id"
                                                ...
                                                @foreach($expo as $ex)
                                                    ...
                                                    <option value="{{$ex->id}}" {{ ($ex->id == $item->expo_id) ? "selected":"" }}>
                            ...
                            <fieldset>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mt-radio-inline">
                                            <label class="mt-radio">
                                                <input type="radio" name="is_sale" id="is_sale_yes" value="on"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="discount" value="{{$item->discount_percentage}}" id="discount"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="choosColor {{$cls}}" style="background-color:#{{$item2->color}}">
                                            ...
                                            <input type="checkbox" name="colors[]" value="{{$item2->id}}" style="display:none;">
                                            </div>
                               ...
                               {{-- <div class="form-group">
                                    ...
                                    <label class="col-sm-2 control-label" for="publish_type_id">

                                        {{__('product.publish_type_id')}}
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="publish_type_id" class="form-control select2" name="publish_type_id"

                                                required>

                                            @foreach($publishes as $publish)

                                                <option value="{{$publish->id}}" {{ ($item->publish_type_id == $publish->id ? "selected":"") }}>
                                ...
                                <div class="input_fields_wrap">
                                    ...
                                    @foreach($videos as $video)
                                        <input type="text" class="col-md-10"
                                               style="margin-left: 10%;height: 35px;margin-bottom: 10px;"
                                               name="product_videos[]" value="{{$video->image}}">
                                    @endforeach
