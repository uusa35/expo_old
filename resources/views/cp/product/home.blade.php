...
@section('content')
    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{url(getLocal().'/admin/product/create')}}" style="margin-right: 5px"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/product')}}" type="submit" class="btn sbold btn-default ">{{('reset')}}
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/product/changeStatus")}}">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
 			...
 			<td>
                            ...
                            <img src="{{(!empty($item->cover_image))? $item->cover_image:''}}" width="50px" height="50px">
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/product/'.$item->id.'/edit')}}"
        ...
        function delete_adv(id, e) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    var url = '{{url(getLocal()."/admin/product")}}/' + id;
