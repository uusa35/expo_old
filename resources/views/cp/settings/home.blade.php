                ...
                <div class="portlet-body form">
                    ...
                    <form method="post" action="{{url(app()->getLocale().'/admin/setting/')}}"
                        ...
                        <div class="form-body">
                            ...
                            @foreach($settings as $setting)
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="{{$setting->key}}" placeholder="{{$setting->key}}"
                            ...
                            @endforeach
                        <fieldset>
                              <legend>{{__('setting.Payment_subscribtion')}}</legend>
                            ...
                            <fieldset>
                                ...
                                <legend>{{__('setting.Terms_and_Policies')}}</legend>
                                <hr>
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                            ...
                                            <textarea class="ckeditor form-control" name="{{$settings[20]->key}}"
                            ...
                            <fieldset>
                                ...
                                <legend>{{__('setting.Location')}}</legend>
