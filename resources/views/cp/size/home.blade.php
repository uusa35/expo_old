@extends('layout.app')
@section('title') {{ucwords(__('common.size'))}}
@endsection
@section('css')
@endsection
@section('content')
        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/size/create')}}" style="margin-right: 5px"
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/size')}}">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/size')}}" type="submit" class="btn sbold btn-default ">{{('reset')}}
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/size/changeStatus")}}">
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/size/'.$item->id.'/edit')}}"
    ...
    <script>
        function delete_adv(id, e) {
            ...
            swal({
                ...
                if (willDelete) {
                    var url = '{{url(getLocal()."/admin/size")}}/' + id;
