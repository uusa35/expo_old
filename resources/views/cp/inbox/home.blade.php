        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/myMessages/create')}}" style="margin-right: 5px"
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/myMessages')}}">
                        <div class="row">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('common.message'))}}</th>
                ...
                @forelse($items as $item)
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <span class="label label-sm <?php echo ($item->status == "read")
                    ...
                    @if(count($item->message)>0)
                     {{$item->message[count($item->message)-1]->message}}
                    @else
                    @endif
                    </td>
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{route('viewMessage',['page_key'=>$item->id])}}"><i class="fa fa-eye"
