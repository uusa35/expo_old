        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <form method="post" action="{{url(app()->getLocale().'/admin/expo/'.$item->id)}}"
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select id="type" class="form-control select2" name="type"
                                        ...
                                        <option value="1" {{ ($item->type_id == '1' ? "selected":"") }}>Expo</option>

                                        <option value="2" {{ ($item->type_id == '2' ? "selected":"") }}>Business
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="designer_name"
                                               value="{{$item->designer_name}}" id="designer_name"

                                               placeholder=" {{__('common.designer_name')}}" {{ old('designer_name') }} required>
                            ...
                            <fieldset>
                                ...
                                <legend>{{__('common.designer-image')}}</legend>
                                ...
                                <div class="form-group {{ $errors->has('designer_image') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-md-6 col-md-offset-3">
                                        ...
                                        <div class="fileinput-new thumbnail"
                                            ...
                                            <img src="{{@$item->user->image}}" id="editImage1">
                                ...
                                <div class="col-md-6">
                                        ...
                                        <select id="multiple" class="form-control select2-multiple" name="category_id[]"
                                            ...
                                            @foreach($categories as $category)
                                                <option value="{{$category->id}}" {{ (in_array($category->id,$ex_categories )? "selected":"") }}>
                                                    {{$category->title}}
                                                </option>
                                            @endforeach
                                        </select>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="control-label col-md-3">Delivery service</label>
                                ...
                                <div class="delivery_block" style="display: {{$item->delivery_service == 'yes'? 'block' :'none'}}">
                                    <button type="button"
                                            class="add_field_button btn green col-md-2">{{__('common.add')}}
                                    </button>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="checkbox" class="make-switch" name="in_slider" id="in_slider" data-size="small" {{ ($item->in_slider == "1" ? "checked":"") }}>
                            ...
                            <div class="form-actions">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url(getLocal().'/admin/expo')}}" class="btn default">{{__('common.cancel')}}</a>
