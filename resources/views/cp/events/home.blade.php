...
@section('title') {{ucwords(__('common.calendar_event'))}}
        ...
        <div class="portlet-body">
            ...
            <div class="table-toolbar">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{url(getLocal().'/admin/calendar_event/create')}}" style="margin-right: 5px"
                            ...
                            <button class="btn sbold red event2" id="delete" >{{__('common.delete')}}
                ...
                <div class="box-filter-collapse">
                    ...
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/calendar_event')}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/calendar_event')}}" type="submit" class="btn sbold btn-default ">{{('reset')}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-3 control-label">{{__('common.type')}}</label>

                                    <div class="col-md-9">

                                        <select class="form-control select2" name="type">

                                            <option value="1">{{__('common.expo')}}</option>

                                            <option value="2"> {{__('common.business')}}</option>
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/calendar_event/changeStatus")}}">
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/calendar_event/'.$item->id.'/edit')}}"
        ...
        function delete_adv(id, e) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    var url = '{{url(getLocal()."/admin/calendar_event")}}/' + id;
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response === 'success') {
                                ...
                                swal("{{__('cafe.delete_done')}}", {icon: "success"});
