        ...
        <div class="portlet-body">
            ...
            <div class="table-toolbar">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{url(getLocal().'/admin/package/create')}}" style="margin-right: 5px"
                ...
                <div class="box-filter-collapse">
                    ...
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/package')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-3 control-label">{{__('common.price')}}</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/package')}}" type="submit"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-3 control-label">{{__('common.duration')}}</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-3 control-label" for="status">{{__('common.status')}}</label>
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/package/changeStatus")}}">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('common.duration'))}}</th>
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/package/'.$item->id.'/edit')}}"
        ...
        function delete_adv(id, e) {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    var url = '{{url(getLocal()."/admin/package")}}/' + id;
                    ...
                    $.ajax({
                        ...
                        success: function (response) {
                            ...
                            if (response === 'success') {
                                ...
                                swal("{{__('package.delete_done')}}", {icon: "success"});
