        ...
        <div class="portlet-body">
            <div class="table-toolbar">
                <div class="row">
                    <div class="col-sm-9">
                        <div class="btn-group">
                            <a href="{{url(getLocal().'/admin/currency/create')}}" style="margin-right: 5px"
                ...
                <div class="box-filter-collapse">
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/currency')}}">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="row">
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/currency')}}" type="submit" class="btn sbold btn-default ">{{('reset')}}
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/currency/changeStatus")}}">
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('common.shortcut'))}}</th>
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            <div class="btn-group btn-action">
                                <a href="{{url(getLocal().'/admin/currency/'.$item->id.'/edit')}}"
    ...
    <script>
        function delete_adv(id, e) {
            ...
            swal({
                ...
                if (willDelete) {
                    var url = '{{url(getLocal()."/admin/currency")}}/' + id;
