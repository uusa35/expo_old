        ...
        <div class="portlet-body">
            ...
            <div class="table-toolbar">
                ...
                <div class="box-filter-collapse">
                    ...
                    <form class="form-horizontal" method="get" action="{{url(getLocal().'/admin/myProduct')}}">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-offset-3 col-md-9">
                                        ...
                                        <a href="{{url('admin/myProduct')}}" type="submit" class="btn sbold btn-default ">{{('reset')}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label class="col-md-3 control-label">{{__('common.details')}}</label>
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/myProduct/changeStatus")}}">
            ...
            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="toolsTable">
                ...
                <tr>
                    ...
                    <th> {{ucwords(__('common.details'))}}</th>
                ...
                @forelse($items as $item)
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
			            ...
			            <td>
                            ...
                            <img src="{{$item->cover_image}}" width="50px" height="50px">
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-action">
                                ...
                                <a href="{{url(getLocal().'/admin/myProduct/'.$item->id.'/edit')}}"
