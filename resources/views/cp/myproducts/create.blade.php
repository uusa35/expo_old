        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <form method="post" action="{{url(app()->getLocale().'/admin/myProduct')}}"
                                ...
                                <legend>{{__('product.product')}}{{__('common.details')}}</legend>
                                 ...
                                 <div class="form-group">
                                    ...
                                    {{--<div class="col-md-6">
                                        ...
                                        <input type="checkbox" class="make-switch" name="is_sale"

                                               id="is_sale_no" data-size="small"

                                                {{ (old("is_sale") == "on" ? "checked":"") }} >
