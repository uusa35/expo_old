...
--}}
            ...
            <input type="hidden" id="url" value="{{url("/en/admin/myOrders/changeStatus")}}">
                    ...
                    <tr class="odd gradeX" id="tr-{{$item->id}}">
                        ...
                        <td>
                            ...
                            <div class="btn-group btn-action">
                             ...
                             <a class="btn btn-xs blue tooltips" href="{{url(getLocal().'/admin/order_details/'.$item->id)}}"><i class="fa fa-eye"></i></a>
