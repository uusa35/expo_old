    ...
    <div class="page-sidebar-wrapper">
        <div class="page-sidebar navbar-collapse collapse">
            <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                ...
                <li class="nav-item ">
                    <a href="form-page.html" class="nav-link">
                        <i class="icon-settings"></i>
                        <span class="title">Form Stuff</span>
                    </a>
                </li>
                <li class="nav-item ">
                    <a href="table-page.html" class="nav-link">
                        <i class="icon-briefcase"></i>
                        <span class="title">Tables</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="wizerd.html" class="nav-link">
                        <i class="icon-briefcase"></i>
                        <span class="title">Wizerd</span>
                    </a>
                </li>
                <li class="nav-item  ">
...
<div class="page-footer">
    <div class="page-footer-inner"> 2018 &copy; Theme By
        <a target="_blank" href="#">{{'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'}}</a>
    </div>
