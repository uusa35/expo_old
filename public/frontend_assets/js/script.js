$(document).ready(function(){
	var owl = $('#homeSlider');
	    ...
	    owl.owlCarousel({
	            ...
	            navText:['<span><img src="http://tarteeb.linekw.com/public//images/arrow-left.svg"></span>','<span><img src="http://tarteeb.linekw.com/public//images/arrow-right.svg"></span>'],
	    });
	...
	$("#rating-slide").owlCarousel({
            ...
            dots:true,
            nav:true,
            navText:['<span><img src="http://tarteeb.linekw.com/public//images/Arrow-l.svg"></span>','<span><img src="http://tarteeb.linekw.com/public//images/Arrow-r.svg"></span>'],
            autoplay:false
        ...
        var readURL7 = function(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function (e) {
                    $('.up-img-pic7').attr('src', e.target.result);
                }
